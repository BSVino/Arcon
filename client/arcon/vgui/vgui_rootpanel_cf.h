...
#ifndef VGUI_ROOTPANEL_CF_H
#define VGUI_ROOTPANEL_CF_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class C_CFRootPanel : public vgui::Panel
{
	typedef vgui::Panel BaseClass;
public:
						C_CFRootPanel( vgui::VPANEL parent );
	virtual				~C_CFRootPanel( void );

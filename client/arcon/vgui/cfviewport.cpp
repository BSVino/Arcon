...
void CFViewport::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
IViewPortPanel* CFViewport::CreatePanelByName(const char *szPanelName)
{
...
void CFViewport::CreateDefaultPanels( void )
{
	BaseClass::CreateDefaultPanels();
}

int CFViewport::GetDeathMessageStartHeight( void )
{
	int x = YRES(2);

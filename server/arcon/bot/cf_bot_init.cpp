...
ConVar cv_bot_allow_longswords( "bot_allow_longswords", "1", FCVAR_REPLICATED, "If nonzero, bots may use long swords, eg 2 or 3 slots." );
ConVar cv_bot_allow_longguns( "bot_allow_longguns", "1", FCVAR_REPLICATED, "If nonzero, bots may use long barrel guns, eg shotguns and rifles." );
ConVar cv_bot_allow_busters( "bot_allow_busters", "1", FCVAR_REPLICATED, "If nonzero, bots may use buster swords, eg 4 slots." );
...
extern void FinishClientPutInServer( CCFPlayer *pPlayer );
 ...
 * Constructor
 */
CCFBot::CCFBot( void ) : m_chatter( this ), m_gameState( this )
{
	m_hasJoined = false;
}
...
bool CCFBot::IsReadyToPlay( void )
{

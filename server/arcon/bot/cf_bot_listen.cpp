...
//--------------------------------------------------------------------------------------------------------------
bool CCFBot::IsNoiseHeard( void ) const
{
 ...
 */
bool CCFBot::HeardInterestingNoise( void )
{
 ...
 * -1 == infinite range
 */
bool CCFBot::CanHearNearbyEnemyGunfire( float range ) const
{
 ...
 */
bool CCFBot::CanSeeNoisePosition( void ) const
{
	trace_t result;
 ...
 */
bool CCFBot::UpdateLookAtNoise( void )
{

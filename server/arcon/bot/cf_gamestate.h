...
private:
	CCFBot *m_owner;											///< who owns this gamestate
	...
	bool m_isBombsiteClear[ CCFBotManager::MAX_ZONES ];			///< corresponds to zone indices in CCFBotManager
	int m_bombsiteSearchOrder[ CCFBotManager::MAX_ZONES ];		///< randomized order of bombsites to search
	int m_bombsiteCount;

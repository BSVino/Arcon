 ...
 */
void InvestigateNoiseState::AttendCurrentNoise( CCFBot *me )
{
...
//--------------------------------------------------------------------------------------------------------------
void InvestigateNoiseState::OnEnter( CCFBot *me )
{
 ...
 */
void InvestigateNoiseState::OnUpdate( CCFBot *me )
{
...
//--------------------------------------------------------------------------------------------------------------
void InvestigateNoiseState::OnExit( CCFBot *me )
{

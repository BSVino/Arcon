...
LINK_ENTITY_TO_CLASS( info_player_teamspawn, CCFTeamSpawn );

//-----------------------------------------------------------------------------
// Purpose: Constructor.
//-----------------------------------------------------------------------------
CCFTeamSpawn::CCFTeamSpawn()
{
	m_bDisabled = false;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CCFTeamSpawn::Activate( void )
{
	BaseClass::Activate();
...
// Purpose:
//-----------------------------------------------------------------------------
void CCFTeamSpawn::InputEnable( inputdata_t &inputdata )
{
	m_bDisabled = false;
}
...
// Purpose:
//-----------------------------------------------------------------------------
void CCFTeamSpawn::InputDisable( inputdata_t &inputdata )
{
	m_bDisabled = true;
}
...
//-----------------------------------------------------------------------------
int CCFTeamSpawn::DrawDebugTextOverlays(void) 
{
	...
	if (m_debugOverlays & OVERLAY_TEXT_BIT) 
	{
		...
		// Isn't there an automatic way of converting a Color into a color32?
		teamcolor.r = g_aTeamColors[ GetTeamNumber() ].r();
		teamcolor.g = g_aTeamColors[ GetTeamNumber() ].g();
		teamcolor.b = g_aTeamColors[ GetTeamNumber() ].b();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CCFTeamSpawn::InputRoundSpawn( inputdata_t &input )
{

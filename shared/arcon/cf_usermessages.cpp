...
void RegisterUserMessages()
{
	...
	usermessages->Register( "CFMessage", -1 );
	usermessages->Register( "Armament", -1 );
	usermessages->Register( "CFPanel", 3 );	// Show CFGUI panel
	usermessages->Register( "PlayerInfo", 5 );
	usermessages->Register( "Respawn", 0 );
	usermessages->Register( "LessonLearned", 1 );
	usermessages->Register( "CinematicEvent", -1 );
}

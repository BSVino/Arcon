...
public:
	...
	const BotProfile *GetRandomProfile( BotDifficultyType difficulty, int team, CFWeaponType weaponType ) const;			///< return random unused profile that matches the given difficulty level
